...
<header>
	...
	<body>
        <div class="menu"><br>
            ...
            <button id=login-button class="btn btn-lg btn-primary btn-block" >Save Password</button><br>
            </form>
            ...
            <button id=login-button class="btn btn-lg btn-primary btn-block" >Save Login</button><br>
            </form>
            <form method='post' action='./php/delete_users.php'>
            <button id=login-button class="btn btn-lg btn-danger btn-block" >Delete my Account</button>
            </form>
        </div>
	</body>
</html>